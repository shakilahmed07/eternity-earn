...
const Ourvision = () => {
  return (
    <div className="max-w-7xl m-auto pt-28 px-4 xl:px-0 sm:flex sm:justify-center">
      <h3 className="text-[22px] font-semibold ">ROADMAP</h3>
      <div className="space-y-4 sm:ml-[180px] lg:ml-[400px] xl:ml-[420px]">
        <h2 className="text-4xl font-semibold">Our Vision</h2>
        <p className="xl:pr-[150px] text-[#4D4D4F]">
