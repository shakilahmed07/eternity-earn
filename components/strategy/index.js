    ...
    <section className="bg-[#F4F5F6] py-28">
      <div className="max-w-7xl m-auto px-4 xl:px-0">
        <div className="">
          ...
          <p className="text-center text-sm text-[#4D4D4F]">
            Once $CRO deposit are locked in the Eternity Earn contract, users
            are ecouraged to <br className="hidden sm:inline" /> compound their rewards sit days per week and then
            claim rewards on the seventy day <br className="hidden sm:inline" /> (6:1). By following the recommended
            compound/claim schedule, the maximun daily rewards <br className="hidden sm:inline" /> (up to 8%) can be
            achieved, allowing for a typical return on invesment within four to
            six <br className="hidden sm:inline" /> weeks. All rewards are paid in $CRO tokens based on the total
            value locked (TVL) in the <br className="hidden sm:inline" /> contract liquidity pool and activity
            during the day by other users of the system. The value of <br className="hidden sm:inline" /> $CRO is
